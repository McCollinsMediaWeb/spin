...
var wheelConfig_pink_6 = {
  ...
  sectors: [
    {
      win: "Colgate GRF 75ml-Pack of 4",
      text: "33% Off",
      isBigWin: false,
      icon: "prd1",
      url: "https://cleaningsuperstore.com/products/colgate-grf-75ml-pack-of-4",
    },
    {
      win: "Ariel LS Green 7Kg",
      text: "12% Off",
      isBigWin: false,
      icon: "prd2",
      url: "https://cleaningsuperstore.com/products/ariel-ls-green-7kg",
    },
    {
      win: "Jennifer's Baby Wipes 80's",
      text: "37% Off",
      isBigWin: false,
      icon: "prd3",
      url: "https://cleaningsuperstore.com/products/jennifers-baby-wipes-80s",
    },
    {
      win: "Dettol Hand Wash Fresh 200ML",
      text: "25% Off",
      isBigWin: false,
      icon: "prd4",
      uel: "https://cleaningsuperstore.com/products/dettol-hand-wash-fresh-200ml",
    },
    {
      win: "Dettol Multipurpose Floor Cleaner 3L Pine",
      text: "5% Off",
      isBigWin: false,
      icon: "prd5",
      url: "https://cleaningsuperstore.com/products/dettol-multipurpose-floor-cleaner-3l-pine",
    },
    {
      win: "Win Detergent Powder 25KG",
      text: "7% Off",
      isBigWin: false,
      icon: "prd6",
      url: "https://cleaningsuperstore.com/products/win-detergent-powder-25kg",
    },
  ],
